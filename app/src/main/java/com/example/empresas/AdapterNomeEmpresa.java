...
public class AdapterNomeEmpresa extends BaseAdapter {

    private Context context;
    private List<Lista> lista;
    private LayoutInflater inflater;

    public AdapterNomeEmpresa(Context context, List<Lista> lista) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate
                    (R.layout.layout_nome_empresa, null);
            item = new Suporte();
            item.tvIdTitulo = (TextView)
                    convertView.findViewById(R.id.tvIdNomeEmpresa);
            item.tvTitulo = (TextView)
                    convertView.findViewById(R.id.tvNomeEmpresa);
